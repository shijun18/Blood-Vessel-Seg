...
from data_utils.data_loader import DataGenerator, To_Tensor, CropResize, Random_Trunc_and_Normalize
    ...
    def trainer(self,
        ...
        if self.mode == 'cls':
            train_transformer = transforms.Compose([
                Random_Trunc_and_Normalize(self.scale),
